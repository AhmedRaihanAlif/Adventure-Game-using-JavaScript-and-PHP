  ...
  <div class="nav">
    ...
    <h1 class="ml5">
      <span class="text-wrapper">
        ...
        <span class="letters letters-right">Alpha</span>
    ...
    <ul>
      ...
      <li>
        <div class="dropdown"  >
          ...
          <a href="leader.html">UIU EXPRESS</a>
          <a href="#">JUNGLE SURVIVER</a>
          <a href="#">SEARCH ME</a>
          </div>
        </div>
   ...
   <div class="container">
    <div class ="item1">
        ...
        <div class="flip-card">
            ...
            <h1  style="margin-top: 5px; color: gray;">UIU EXPRESS</h1>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
              ...
              <div id="hj" class="flip-card-back">
                <h1 style="margin-top: 5px; color: gray;">Jungle Surviver</h1> 
                <form method="post" >
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
              ...
              <div id="hk" class="flip-card-back">
                <h1  style="margin-top: 5px; color: gray;">Search Me</h1> 
                <button id="b3" class="button">Play</button>
              </div>
            </div>
          </div>
...
<script>
  var typed =new Typed(
    ".auto-type",{
      strings:["Alif","Ahmed Raihan Alif","Zulkar","Rakib"],
      typeSpeed:150,
      backSpeed:150,
      loop:true
    }
