...
<head>
    ...
    <title>Jungle Book - Level 2</title>
...
if(isset($_POST['submit'])){
  $username=$_GET['username'];
  $url="jungle6.php?username=".$username;
header('location: '.$url);
}
...
?>
  <center>
   ...
   <!-- <p id="demo"> </p> -->
    ...
    <div  id="myDIV">
        <center>
          <h2 id="borderimg1" style="color: rgb(0, 116, 224);">Pheew!! Kaa is gone
            <br>
            But now Mowgli is tired<br>
            What should he do??
          </h2>
          ...
          <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
                                 Phew! Kaa is gone. But now Mowgli is tired. What should he do??
</textarea> 
    ...
    <div class ="item2">
        ...
        <div class="card3">
            <img src="jungleCSS/51.png" alt="Denim Jeans" style="width:100%;height: 50vh;">
            <h1 id="bus" class="bus">Get Some Sleep</h1>
            ...
            <div class ="item3">
                <div class="card4">
                    ...
                    <h1 id="bike"  class="rickshaw">Eat some Bannanas</h1>
