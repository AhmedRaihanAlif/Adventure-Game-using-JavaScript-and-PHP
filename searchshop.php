  ...
  <center>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1">   
         ...
         If you give him full tk it may reach you in time<br>

        But you are late to reach the class in time.....
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          You have lost 3 Minutes
          If you give him full tk it may reach you in time
 
         But you are late to reach the class in time </textarea>
